...
def scribe_audio(audio_path):
    ...
    result = scribe_pipe(audio_path, return_timestamps="True", chunk_length_s=30, batch_size=16, condition_on_previous_text:False, generate_kwargs={"language":"spanish", "prompt_ids": forced_prompt_ids})
